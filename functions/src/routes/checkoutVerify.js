// functions/src/routes/checkoutVerify.js
...
async function markInvalidSignature({
  orderRef,
  uid,
  razorpayOrderIdFromDb,
  razorpayPaymentId,
  ...
  await orderRef.collection("events").add({
    ...
    source: "firebase-functions/checkout-verify",
    actor: {
      type: "customer",
      uid,
    },
...
async function checkoutVerify(req, res) {
